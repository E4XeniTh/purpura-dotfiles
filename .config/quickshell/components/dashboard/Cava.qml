...
// producing frozen bars, so this runs helpers/cava_bridge - a small
// compiled helper (same pattern as helpers/auth.c) that links against
// libcava (LukashonakV/cava's fork, built as a shared library - see
// github.com/LukashonakV/cava) and prints the same semicolon-separated
